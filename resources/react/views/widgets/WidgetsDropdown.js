...
// {/* ── NEW: Tax Collected ── */}
//         <CCol sm={6} lg={3} xl={3} xxl={3}>
//           <CWidgetStatsA
//             className="pb-3"
//             style={{ backgroundColor: '#5DADE2' }}   // ← nice blue – you can change
//             value={
//               <>
//                 <span className="fs-4 fw-semibold" style={{ color: 'white' }}>
//                   {formatCurrencyWithCommas(
//                     props.reportMonth?.totals?.totalTax ||
//                     props.reportMonth?.monthlyTax?.[currentMonth] ||
//                     0
//                   )}
//                 </span>
//                 <span className="fs-6 fw-normal ms-2" style={{ color: 'white' }}>
//                   {t('LABELS.in')} {reportMonth.currentMonth}
//                 </span>
//               </>
//             }
