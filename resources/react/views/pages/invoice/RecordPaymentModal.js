...
//     const totalAmount = parseFloat(orderData.finalAmount ?? orderData.totalAmount ?? orderData.billing_amount ?? 0) || 0
//     const currentPaid = parseFloat(orderData.paidAmount ?? 0) || 0

//     if (isEdit) {


//       // const totalAmount = Number(orderData.finalAmount || 0)
// // const totalPaid   = Number(orderData.paidAmount || 0)





// const totalAmount = Number(orderData.finalAmount || orderData.totalAmount || 0)
// const original = Number(orderData.received_amount || 0)

// // IMPORTANT: paidAmount मध्ये current payment already आहे
// const totalPaidIncludingCurrent = Number(orderData.paidAmount || 0)

// // 👉 current payment वगळ
// const paidWithoutCurrent = totalPaidIncludingCurrent - original

// const pending = totalAmount - paidWithoutCurrent
...
// // ✅ EDIT MODE
// const maxAllowed = pending + original

// setMaxAllowed(maxAllowed > 0 ? maxAllowed : 0)


//       const currentAmount = parseFloat(orderData.received_amount ?? orderData.amount ?? 0) || 0
//       setOriginalAmount(currentAmount)

//       // Calculate max allowed for edit: total - (currentPaid - original) = total - currentPaid + original
//       const effectiveMax = totalAmount - currentPaid + currentAmount
//       setMaxAllowed(effectiveMax)
...
//     // Validate received amount (for both new and edit)
//     // if (name === 'received_amount') {
//     //   const receivedAmount = parseFloat(value) || 0

//     //   if (receivedAmount > maxAllowed) {
//     //     showAlert(`Amount cannot exceed maximum allowed of ₹${maxAllowed.toLocaleString()}`, 'danger')
//     //     return
//     //   }
//     // }
...
//   if (val > maxAllowed) {
//     showAlert(
//       `Amount cannot exceed ₹${maxAllowed.toLocaleString()}`,
//       'danger'
//     )
//     return
//   }
...
//   // const remainingAmount = isEdit ? 0 : (totalAmount - paidAmount)
//   // const totalAmount = Number(orderData.finalAmount || orderData.totalAmount || 0)
// const alreadyPaid = Number(orderData.paidAmount || 0)

// // EDIT MODE: add back original payment before checking
// const remainingAmount = isEdit
//   ? totalAmount - (alreadyPaid - originalAmount)
...
//               />
//               <small className="text-muted">
//                 Maximum: ₹{maxAllowed.toLocaleString()}
//               </small>
//             </CCol>
//             <CCol lg={6} md={6} sm={6} xs={12}>
//               <CFormLabel htmlFor="payment_date">Payment Date *</CFormLabel>
