...
//           <span>🏗️ Machinery Stock Update List</span>
//           <div style={{ display: 'flex', gap: '10px' }}>
//             <button style={styles.addBtn} onClick={() => navigate('/machineryStockUpdate')}>+ Add New Stock</button>
//             <button style={styles.excelBtn} onClick={downloadExcel}>📥 Download Excel</button>
//           </div>
//         </CCardHeader>
...
//                           {/* ── Expanded Child Row — must span ALL parent columns ── */}
//                           {isExpanded && (
//                             <tr>
//                               <td colSpan={PARENT_COL_COUNT} style={{ padding: 0, border: 'none' }}>
//                                 <div style={styles.childSection}>
//                                   <div style={styles.childTitle}>
//                                     📦 Stock Items for <strong>{record.project?.project_name}</strong> — {record.machine?.machine_name}
//                                   </div>
...
//           <CModalTitle>📋 Stock History — {selectedStockForLogs?.stock_name}</CModalTitle>
//         </CModalHeader>
//         <CModalBody>
//           {logsLoading ? (
...
//         <CModalHeader style={{ background: '#1e3a5f', color: '#fff' }}>
//           <CModalTitle>✏️ Edit Main Stock Update</CModalTitle>
//         </CModalHeader>
//         <CModalBody>
//           <CRow className="g-3">
//             <CCol md={4}>
